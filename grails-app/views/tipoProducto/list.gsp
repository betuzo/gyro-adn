			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="clave" title="${message(code: 'tipoProducto.clave.label', default: 'Clave')}" />
				...
				<g:each in="${tipoProductoInstanceList}" status="i" var="tipoProductoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoProductoInstance.id}">${fieldValue(bean: tipoProductoInstance, field: "clave")}</g:link></td>
