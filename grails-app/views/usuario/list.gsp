			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="codigoPostal" title="${message(code: 'usuario.codigoPostal.label', default: 'Codigo Postal')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "codigoPostal")}</td>
